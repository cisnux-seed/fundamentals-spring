...
public class UploadController {
    ...
    @ResponseBody
    public String upload(@RequestParam(name = "name") String name, @RequestPart(name = "profile") MultipartFile profile) throws IOException {
        Files.createDirectories(Path.of("upload"));
        final var path = Path.of("upload/" + profile.getOriginalFilename());
