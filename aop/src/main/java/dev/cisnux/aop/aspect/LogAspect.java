...
public class LogAspect {
    @Pointcut("execution(* dev.cisnux.aop.services.HelloService.*(java.lang.String))")
    public void pointcutHelloServiceStringParam() {
    }

    @Pointcut("target(dev.cisnux.aop.services.HelloService)")
    public void helloServiceMethod() {
    }

    @Pointcut("execution(* dev.cisnux.aop.services.*.*(..))")
...
//        final var value = ((String) joinPoint.getArgs()[0]);
